...
def ppo_cnp(env_fn, actor_critic=core.CNPActorMLPCritic, ac_kwargs=dict(), seed=0, 
    ...
    ac = actor_critic(env.observation_space, env.action_space, use_time_input=use_time_input, **ac_kwargs)
    # FREEZE THE ENCODER of the actor
    for param in ac.pi.cnp.encoder.parameters():
